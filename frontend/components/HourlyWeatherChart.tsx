        ...
        <div className="chart-container">
            ...
            <ResponsiveContainer width="100%" height={400}>
                <LineChart data={chartData} margin={{top: 5, right: 30, left: 20, bottom: 5}}>
                    ...
                    <Tooltip/>
                    <Legend/>
                    <Line yAxisId="left" type="monotone" dataKey="temp" stroke="#ff6b6b" strokeWidth={2}
                          name="Temperature (°C)"/>
                    <Line yAxisId="left" type="monotone" dataKey="feelsLike" stroke="#ffa500" strokeWidth={2}
                          name="Feels Like (°C)"/>
                    <Line yAxisId="right" type="monotone" dataKey="humidity" stroke="#4ecdc4" strokeWidth={2}
                          name="Humidity (%)"/>
                    <Line yAxisId="right" type="monotone" dataKey="precipitation" stroke="#95a5a6" strokeWidth={2}
