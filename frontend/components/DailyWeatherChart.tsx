    ...
    <div className="chart-container">
      ...
      <ResponsiveContainer width="100%" height={400}>
        <LineChart data={chartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
          ...
          <Line yAxisId="left" type="monotone" dataKey="minTemp" stroke="#4ecdc4" strokeWidth={2} name="Min Temp (°C)" />
          <Line yAxisId="left" type="monotone" dataKey="avgTemp" stroke="#45b7d1" strokeWidth={2} name="Avg Temp (°C)" />
          <Line yAxisId="right" type="monotone" dataKey="humidity" stroke="#96ceb4" strokeWidth={2} name="Humidity (%)" />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
